...
func c_hbase_region() (datapoint.MultiDataPoint, error) {
	var j jmx
...
func c_hbase_gc() (datapoint.MultiDataPoint, error) {
	var j jmx
...
func c_hbase_replication() (datapoint.MultiDataPoint, error) {
	var j jmx
